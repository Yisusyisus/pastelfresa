...
<head>
  ...
  <script
    src="//apps.8thwall.com/xrweb?appKey=833aWpyWNk2wC9Q18Lw6rzKw8239QpN2XLnh8n8jUC43nFym0PV8wxKWeJzzVyOjpETPba"></script>
...
<body>
  ...
  <a-scene
    ...
    <a-assets>
      <a-asset-item id="frame-glb" src="pastel.glb"></a-asset-item>
    </a-assets>
    ...
    <a-entity image-target>
      ...
      <a-entity id="frame"  position="1 0 -8"  scale="2 2 2" rotation="10 30 0" gltf-model="#frame-glb"></a-entity>
